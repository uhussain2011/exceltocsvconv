...
//		$this->styles = array();
        ...
        if ( $relations = $this->getEntryXML("_rels/.rels" ) ) {
            ...
            foreach ($relations->Relationship as $rel) {
                ...
                if ($rel["Type"] == ExcelToArray::SCHEMA_REL_OFFICEDOCUMENT) {
...
//							echo 'workbook relations<br />';
                            ...
                            foreach ($workbookRelations->Relationship as $workbookRelation) {
                                ...
                                if ($workbookRelation['Type'] == ExcelToArray::SCHEMA_REL_WORKSHEET) { // Sheets
...
//										echo '<pre>'.htmlspecialchars( print_r( $sheet, true ) ).'</pre>';
                                ...
                                } else if ($workbookRelation['Type'] == ExcelToArray::SCHEMA_REL_SHAREDSTRINGS && $this->entryExists( $path )) { // 0.6.6
...
//									echo 'sharedstrings<br />';
                                ...
                                } else if ($workbookRelation['Type'] == ExcelToArray::SCHEMA_REL_STYLES) {
